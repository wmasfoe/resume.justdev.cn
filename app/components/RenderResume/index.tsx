    ...
    <div className={`${styles.resumeContainer} ${styles.variables}`}>
      ...
      <header className={styles.profileCard}>
        <div className={styles.nameAndProfession}>
          ...
          <div className={`${styles.pcVersionChange} ${styles.onlineOnly} ${styles.mobileOnly}`}>
            <TargetVersion/>
          </div>
          <div className={styles.profilesDetail}>
            <p className={styles.jobTitle}>{resumeData.basics.label}</p>
            {
              resumeData.basics.profiles.gitHub && (
                <>
                  <span className={`${styles.detail} ${styles.split}`}>|</span>
                  <span className={styles.detail}>
                    <a href={resumeData.basics.profiles.gitHub.url} className={styles.notBorderBottom} target="_blank"
            ...
            {
              resumeData.basics.profiles.portfolio && (
                <>
                  <span className={`${styles.detail} ${styles.split}`}>|</span>
                  <span className={styles.detail}>
                    <a href={resumeData.basics.profiles.portfolio.url} className={styles.notBorderBottom}
                      target="_blank"
                      rel="noopener noreferrer">
                      <svg width="16" height="16" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
